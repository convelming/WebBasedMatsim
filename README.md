...
The whole project is developed via Intellij Idea, the framework is Springboot 2 with my batis. It uses MATSim 2025.0 for development.
detailed configs and documents are comming soon with integration of ActivitySim and UrbanSim ~
