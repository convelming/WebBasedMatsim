    ...
    function (buildUtil, common, config) {
                    ...
                    for (var index = 0; index < elements.length; index++) {
                        ...
                        if (!common.isEmpty(element.verify) && (ifResult == undefined || ifResult == true)) {
                            ...
                            if (element.error) {
                                ...
                                var errorDom = $("*[name=" + tabName + "]").parent().siblings("*[name='" + errorMsgName + "']");
                ...
                if (element.isSubmit != false) {
                    ...
                    if (elementValue) {
                        if (element.type == "text" || element.type == "password" || element.type == "hidden"){
                            ...
                            $("input[name='" + tabName + filePathNameSuffix + "']").val(elementValue);
        ...
        function drawBoardObj() {
            ...
            var connectFn = {
                ...
                uncheckAll: function (drawBoardId) {
                    $("#" + connectIdPrefix + drawBoardId + " svg").children().each(function () {
        ...
        function tableObj() {
            ...
            var tableData = {};
            var tableConfig = {
                name: "table", properties: { class: "p-table" }, children: [
                ...
                remove: function (tableId, key) {
                    ...
                    if (curr) {
                        ...
                        if (keyIndex > 0) {
                            ...
                            $("#" + idPrefix + tableId).find(td["name='" + colNamePrefix + key + "'"]).remove();
                        }
                    }
                }
            };
            rowFn = {
                ...
                add: function (tableId, data, index) {
                    ...
                    if (curr) {
                        ...
                        var indexTr = $("#" + idPrefix + tableId).children("tbody").children("tr:eq(" + index + ")");
                ...
                remove: function (tableId, index) {
                    ...
                    if (curr) {
                        ...
                        $("#" + idPrefix + tableId).children("tbody").children("tr:eq(" + index + ")").remove();
                    }
                },
                ...
                setData: function (tableId, data, index) {
                    ...
                    if (curr) {
                        ...
                        if (!index) {
                            ...
                            $("#" + idPrefix + tableId).children("tbody").html(newDataHtml);
                        } else {
                            data.$index = index + 1 + "";
                            var newDataHtml = buildBody(tableId, header, data, showIndex, showCheck);
                            $("#" + idPrefix + tableId).children("tbody").children("tr:eq(" + index + ")").html(newDataHtml);
                            curr.params.body.splice(index, 0, data);
                        }
                    }
                }
            ...
            tabFn = {
                checked: function (id, elementId) {
                    ...
                    if (currTabs) {
                        ...
                        if (currTab) {
                            var titleDom = $("#" + idPrefix + id).children("ul").children("li[name='" + tabNamePrefix + elementId + "']");
                            titleDom.addClass("p-checked");
                            titleDom.siblings("li").removeClass("p-checked");
                            var bodyDom = $("#" + idPrefix + id).children("div").children("div[name='" + tabNamePrefix + elementId + "']");
                ...
                open: function (id, params) {
                    ...
                    if (currTabs) {
                        ...
                        if (currTab) {
                            ...
                            $("#" + idPrefix + id).children("ul").append(buildUtil.buildModule(tabObj.config.title));
                            $("#" + idPrefix + id).children("div").append(buildUtil.buildModule(tabObj.config.body));
                ...
                close: function (id, elementId) {
                    ...
                    if (currTabs) {
                        ...
                        if (currTab) {
                            ...
                            var checkedLi = $("#" + idPrefix + id).children("ul").children(".p-checked");
        ...
        // nav module ------------------------------------------------------------------------
        function navObj() {
            var index = 0, listIndex = 0, groupIndex = 0, nodeIndex = 0;
            ...
            navFn = {
                        ...
                        if (currList) {
                            ...
                            if (currNode) {
                                if (currNode.to && currNav.list["list" + currNode.to]) {
                                    ...
                                    $("#" + listIdPrefix + id + "_" + currNode.to).siblings().css("display", "none");
                                }
                ...
                unCheckedAll: function (id) {
                    var currNav = navData["part" + id];
                    if (currNav) $("#" + idPrefix + id + " .p-nav-children").children().css("display", "none");
                }
            };
                        ...
                        if (loadParams && loadParams.url && loadParams.temp) {
                            if (!loadParams.success)
                                loadParams.success = function (data) {
                                    ...
                                    $("#" + moduleSetting.idPrefix + moduleId).find("div[part='list']").html(listHtml);
                                };
                        ...
                        if (loadParams && loadParams.url && loadParams.temp) {
                            if (!loadParams.success)
                                loadParams.success = function (data) {
                                    ...
                                    $("#" + moduleSetting.idPrefix + moduleId).find("div[part='content']").html(contentHtml);
                                };
                            moduleCommon.ajax(loadParams, moduleObj.params.page, moduleSetting);
                        }
                    }
                    ...
                    linkTo: function () {
                        ...
                        if (currButton.url)
                            moduleCommon.ajax({
                                ...
                                success: function () { window.location.href = currButton.linkTo; }
                    ...
                    update: function () {
                        ...
                        if (currButton.url) {
                            ...
                            moduleCommon.ajax({
                                ...
                                type: currButton.requestType,
                                params: updateData,
                                success: function () { formFn.loadData(currModule.id); }
                            }, undefined, moduleSetting);
                        }
                    }
                }
        ...
        var tableModule = function () {
                    ...
                    if (moduleObj) {
                        ...
                        if (moduleParams.table && moduleParams.table.load) {
                            ...
                            moduleCommon.ajax({
                                ...
                                type: dataLoad.type,
                                params: search,
                                success: function (data) { parts.table.row.setData(moduleParams.table.id, data); }
                        ...
                        if (currButton.url) {
                            ...
                            if (submitParamKeys) {
                                for (var submitParamKey in submitParamKeys) {
                                    if (submitParamKeys.hasOwnProperty(submitParamKey))
                            ...
                            moduleCommon.ajax({
                                ...
                                type: currButton.requestType,
                                params: submitParams,
                                success: function () { formFn.loadData({ moduleId: currModule.id }); }
                            }, undefined, moduleSetting);
            ...
            var windowsFn = {
                ...
                init: function (params) {
                    ...
                    if (moduleObj) {
                        var moduleParams = moduleObj.params;
                        if (moduleParams.window)
                            modules.windows.form.initData(moduleParams.window.id, params.data);
                    }
                },
                click: function () {
                    var call = this.call;
